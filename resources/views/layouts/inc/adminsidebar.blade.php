    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#ui-category" aria-expanded="false" aria-controls="ui-category">
          <i class="mdi mdi-tablet-ipad menu-icon"></i>
          ...
          <ul class="nav flex-column sub-menu">
            <li class="nav-item {{Request::is('admin/categories')? 'active':'' }}">
                <a class="nav-link" href="{{ url('admin/categories') }}">
                    <i class="mdi mdi-subdirectory-arrow-right menu-icon"></i>View</a>
            </li>
            <li class="nav-item {{ Request::is('admin/add-categories')?'active':''}}"> 
                <a class="nav-link" href="{{ url('admin/add-categories') }}">
                    <i class="mdi mdi-lead-pencil menu-icon"></i>Create</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
          ...
          <ul class="nav flex-column sub-menu">
            <li class="nav-item {{Request::is('admin/products')? 'active':'' }}"> 
                <a class="nav-link" href="{{ url('admin/products') }}">
                    <i class="mdi mdi-subdirectory-arrow-right menu-icon"></i>
                    View
                </a>
            </li>
          ...
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item {{Request::is('admin/orders')? 'active':'' }}"> 
                <a class="nav-link" href="{{ url('admin/orders') }}">
                    <i class="mdi mdi-subdirectory-arrow-right menu-icon"></i>View</a></li>
