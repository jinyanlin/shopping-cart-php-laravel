                ...
                <form action="{{ url('/add-rating') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="comment col-md-9">
                            <label for="">寫下您的評論</label>
                            <textarea rows="10" cols="50" resize="none" name="comment" class="comment-text" id="" ></textarea>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('/add-rating') }}" method="POST">
                    ...
                    <div class="mb-3">
                    <label for="comment_text" class="col-form-label">評論:</label>
                    <textarea class="form-control" id="comment_text" placeholder="歡迎顧客回應產品使用狀況..."></textarea>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-9">
                                ...
                                @if ($products->quantity > '0')
                                    <button type="button" class="btn btn-primary me-3 float-start addCartBtn">
                                        <i class="bi bi-shop-window">加入到購物車</i>
                                    </button>                
                                @endif
